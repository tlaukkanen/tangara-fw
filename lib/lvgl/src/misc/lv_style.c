...
const uint8_t _lv_style_builtin_prop_flag_lookup_table[_LV_STYLE_NUM_BUILT_IN_PROPS] = {
    ...
    [LV_STYLE_IMAGE_OPA] =                 LV_STYLE_PROP_FLAG_INHERITABLE,
    [LV_STYLE_IMAGE_RECOLOR] =             LV_STYLE_PROP_FLAG_INHERITABLE,
    [LV_STYLE_IMAGE_RECOLOR_OPA] =         LV_STYLE_PROP_FLAG_INHERITABLE,
