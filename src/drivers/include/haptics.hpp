...
class Haptics {
 ...
 private:
  // See the datasheet for the following section references:
  ...
  enum class Effect {
    ...
    kTransitionRampUpLongSmooth10to_50Pct = 106,
    kTransitionRampUpLongSmooth20to_50Pct = 107,
    kTransitionRampUpMediumSmooth10to_50Pct = 108,
    kTransitionRampUpMediumSmooth20to_50Pct = 109,
    kTransitionRampUpShortSmooth10to_50Pct = 110,
    kTransitionRampUpShortSmooth20to_50Pct = 111,
    kTransitionRampUpLongSharp10to_50Pct = 112,
    kTransitionRampUpLongSharp20to_50Pct = 113,
    kTransitionRampUpMediumSharp10to_50Pct = 114,
    kTransitionRampUpMediumSharp20to_50Pct = 115,
    kTransitionRampUpShortSharp10to_50Pct = 116,
    kTransitionRampUpShortSharp20to_50Pct = 117,
    kLongbuzzforprogrammaticstopping_100Pct = 118, // WARNING
